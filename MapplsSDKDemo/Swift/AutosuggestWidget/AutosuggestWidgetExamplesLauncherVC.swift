...
protocol AutosuggestWidgetDelegate: class {
    ...
    func autocompleteDidSelect(viewController: UIViewController, place: MapplsAtlasSuggestion)
...
@objc class AutosuggestWidgetExamplesLauncherVC: UIViewController {
    ...
    @objc func settingsButtonTapped(sender: UIBarButtonItem) {
        let vc =  MapplsDemoSettingsVC(nibName: nil, bundle: nil)
...
extension AutosuggestWidgetExamplesLauncherVC: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case .textFieldSearch:
            ...
            autosuggestWidgetTextFieldSearchVC.searchField.canBecomeFirstResponder ? autosuggestWidgetTextFieldSearchVC.searchField.becomeFirstResponder() : nil
    ...
    func presentAutocompleteController(withBackgroundColor backgroundColor: UIColor, selectedTableCellBackgroundColor: UIColor, darkBackgroundColor: UIColor, primaryTextColor: UIColor, highlightColor: UIColor, secondaryColor: UIColor, tintColor: UIColor, searchBarTintColor: UIColor, separatorColor: UIColor) {
        ...
        // MapplsAutocompleteViewController. Here we use appearanceWhenContainedInInstancesOfClasses to
        ...
        let appearance = UIActivityIndicatorView.appearance(whenContainedInInstancesOf: [DemoStyledAutocompleteViewController.self])
        ...
        let acController = DemoStyledAutocompleteViewController()
    ...
    func showPlaceDetail(place: MapplsAtlasSuggestion) {
